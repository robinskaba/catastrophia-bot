...
class Config:
    ...
    PLAYTIMES_DATASTORE_NAME = _require_config("PLAYTIMES_DATASTORE_NAME")
    LEADERBOARDS_DATASTORE_NAME = _require_config("LEADERBOARDS_DATASTORE_NAME")
    LEADERBOARDS_TOP10_DATASTORE_NAME = _require_config(
